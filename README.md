...
// Make a POST request
const postResponse = await $http.post('/api/data', { name: 'John' });
...
const deleteResponse = await $http.delete('/api/data/1');
console.log(deleteResponse.data);

// Make a PUT request
const putResponse = await $http.put('/api/data/1', { name: 'John' });
